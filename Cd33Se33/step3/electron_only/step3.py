...
####################
# 2.0. Generate the homo -> lumo+n excitations. We know before hand that 42 is to be the highest considered excitation. Spin-polarization is not considered in this study, so excitation of only 1 spin type (alpha herein) is chosen. These "excitations" are in the format of how CP2K would output them. We do this because the routine used below can transform this format of "excitations" into a format expected by Libra
unique_SDs = []
for i in range(28,42):
    unique_SDs.append(['28, %d'%i])
print(unique_SDs)
