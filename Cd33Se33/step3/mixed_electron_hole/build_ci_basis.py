...
"""
    2.0. We begin by obtaining the following items for all timesteps:
        ...
        2. Normalized "CI" coefficients
        3. Update a list of unique SD states that comprise the CI-like excitations

"""
     
# State energies, ci coefficients, unique SDs
res_dir = "_res"
os.system("rm -rf _res")
os.mkdir(res_dir)
curr_step = start_time
min_band=270
max_band=310
ks_orbital_homo_index=297
...
params["logfile_directory"] = "all_logfiles"
