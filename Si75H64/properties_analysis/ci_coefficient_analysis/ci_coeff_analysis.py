...
plt.title("300 K Si$_{75}$H$_{64}$", fontsize=10)
#plt.title("0 K Si$_{75}$H$_{64}$", fontsize=10)
...
plt.tight_layout()
plt.savefig('Si75H64_excitation_analysis_300K.png', dpi=300)
#plt.savefig('Si75H64_excitation_analysis_0K.png', dpi=300)
