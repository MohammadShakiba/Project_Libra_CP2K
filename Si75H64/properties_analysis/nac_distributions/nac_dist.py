...
for subtraj in range(nsubtrajs):
    ...
    for mvalue in range(len(mvalues)):
        ...
        print( hvib_mb[0][-1].get(49,50) * 1000.0 * units.au2ev )
...
plt.subplot(1,1,1)
plt.title('Si$_{75}$H$_{64}$', fontsize=fs)
...
plt.tight_layout()
plt.savefig("Si75H64_NAC_Dist_MB_vs_SD_0_10.png", dpi=600)
...
plt.tight_layout()
plt.savefig("Si75H64_NAC_Dist_MB_vs_SD_10_50.png", dpi=600)
...
plt.tight_layout()
plt.savefig("Si75H64_NAC_Dist_MB_vs_SD_50_150.png", dpi=600)
