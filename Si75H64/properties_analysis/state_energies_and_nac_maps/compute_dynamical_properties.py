...
def myfunc( subtraj ):
    ...
    plt.subplot(1,1,1)
    plt.title('Si$_{75}$H$_{64}$ Many-body', fontsize=10) # traj'+str(subtraj)+'', fontsize=10)
    ...
    plt.tight_layout()
    plt.savefig("Si75H64_mb_Energies_"+str(subtraj)+".png", dpi=300)

    plt.figure(num=None, figsize=(3.21, 2.41), dpi=300, edgecolor='black', frameon=True)
    plt.subplot(1,1,1)
    plt.title('Si$_{75}$H$_{64}$ MB NACs', fontsize=10) # traj'+str(subtraj)+'', fontsize=10)
    ...
    plt.imshow( mb_tnacs, cmap='hot', interpolation='nearest', vmin=0, vmax=150)
    cb = plt.colorbar(label="meV")
    cb.ax.tick_params(labelsize=10)
    plt.tight_layout()
    plt.savefig("Si75H64_mb_tnacs.png")

    plt.figure(num=None, figsize=(3.21, 2.41), dpi=300, edgecolor='black', frameon=True)
    plt.subplot(1,1,1)
    plt.title('Si$_{75}$H$_{64}$ Single-Particle', fontsize=10) # traj'+str(subtraj)+'', fontsize=10)
    plt.xlabel('Time, fs',   fontsize=10)
    plt.ylabel('Energy, eV', fontsize=10)
    plt.ylim(1.5,3)
    plt.yticks([2,3])
    ...
    plt.tight_layout()
    plt.savefig("Si75H64_mixed_sd_Energies_"+str(subtraj)+".png", dpi=300)

    plt.figure(num=None, figsize=(3.21, 2.41), dpi=300, edgecolor='black', frameon=True)
    plt.subplot(1,1,1)
    plt.title('Si$_{75}$H$_{64}$ SD NACs', fontsize=10) # traj'+str(subtraj)+'', fontsize=10)
    ...
    plt.xticks(range(0,nstates_mixed_sd,20))
    plt.yticks(range(0,nstates_mixed_sd,20))
    plt.imshow( mixed_sd_tnacs, cmap='hot', interpolation='nearest', vmin=0, vmax=150)
    cb = plt.colorbar(label="meV")
    cb.ax.tick_params(labelsize=10)
    plt.tight_layout()
    plt.savefig("Si75H64_mixed_sd_tnacs.png")

    plt.figure(num=None, figsize=(3.21, 2.41), dpi=300, edgecolor='black', frameon=True)
    plt.subplot(1,1,1)
    plt.title('Si$_{75}$H$_{64}$ e$^{-}$', fontsize=10) # traj'+str(subtraj)+'', fontsize=10)
    plt.xlabel('Time, fs',   fontsize=10)
    plt.ylabel('Energy, eV', fontsize=10)
    plt.ylim(1.5,3)
    plt.yticks([2,3])
    for sd_index in range( nstates_elec_sd ):
        plt.plot(md_time, elec_sd_energies[sd_index]*units.au2ev, label="", linewidth=1)
    plt.tight_layout()
    plt.savefig("Si75H64_elec_sd_Energies_"+str(subtraj)+".png", dpi=300)

    plt.figure(num=None, figsize=(3.21, 2.41), dpi=300, edgecolor='black', frameon=True)
    plt.subplot(1,1,1)
    plt.title('Si$_{75}$H$_{64}$ e$^{-}$ NACs', fontsize=10) # traj'+str(subtraj)+'', fontsize=10)
    ...
    plt.imshow( elec_sd_tnacs, cmap='hot', interpolation='nearest', vmin=0, vmax=150)
    cb = plt.colorbar(label="meV")
    cb.ax.tick_params(labelsize=10)
    plt.tight_layout()
    plt.savefig("Si75H64_elec_sd_tnacs.png")

    plt.figure(num=None, figsize=(3.21, 2.41), dpi=300, edgecolor='black', frameon=True)
    plt.subplot(1,1,1)
    plt.title('Si$_{75}$H$_{64}$ h$^{+}$', fontsize=10) # traj'+str(subtraj)+'', fontsize=10)
    plt.xlabel('Time, fs',   fontsize=10)
    plt.ylabel('Energy, eV', fontsize=10)
    plt.ylim(1.5,3)
    plt.yticks([2,3])
    for sd_index in range( nstates_hole_sd ):
        plt.plot(md_time, hole_sd_energies[sd_index]*units.au2ev, label="", linewidth=1)
    plt.tight_layout()
    plt.savefig("Si75H64_hole_sd_Energies_"+str(subtraj)+".png", dpi=300)

    plt.figure(num=None, figsize=(3.21, 2.41), dpi=300, edgecolor='black', frameon=True)
    plt.subplot(1,1,1)
    plt.title('Si$_{75}$H$_{64}$ h$^{+}$ NACs', fontsize=10) # traj'+str(subtraj)+'', fontsize=10)
    ...
    plt.imshow( hole_sd_tnacs, cmap='hot', interpolation='nearest', vmin=0, vmax=150)
    cb = plt.colorbar(label="meV")
    cb.ax.tick_params(labelsize=10)
    plt.tight_layout()
    plt.savefig("Si75H64_hole_sd_tnacs.png")
